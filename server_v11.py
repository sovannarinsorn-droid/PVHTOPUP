...
STATIC_DIR = BASE_DIR  # index_v4.html + admin_v3.html live alongside this file
...
@app.route("/")
def serve_index():
    return send_from_directory(STATIC_DIR, "index_v4.html")
...
def create_payment():
    ...
    if not user_id or not game_code or not product_id:
